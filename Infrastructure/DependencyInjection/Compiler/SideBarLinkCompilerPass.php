...
use WideMorph\Ims\Bundle\ImsCategoryBundle\Interaction\MorphViewInteractionInterface;
...
class SideBarLinkCompilerPass implements CompilerPassInterface
{
    ...
    public function process(ContainerBuilder $container)
    {
        if ($container->hasDefinition(MorphViewInteractionInterface::SIDE_BAR_LINK_SERVICE_NAME)) {
            ...
            $sideBarLink->addMethodCall('addLink', ['category_ims_category_list', 'Category', 1]);
        }
    }
}
